    ...
    <div className='2xl:mx-24 xl:mx-20 lg:mx-20 md:mx-20 sm:mx-10 mx-5 mb-16 mt-10'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-8'>
        {courses.map((course, index) => (
          <div key={index} className='courses_main'>
            <div className={`p-5 border-b-2 ${course.cardBgClass}`}>
              <div className='flex justify-around'>
                <span> 
                  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className={course.iconClass} height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <span><Image src={cardsimg1} alt='cardsimg1' /></span>
              </div>
              <h4>{course.title}</h4>
              <div className='flex gap-5'>
                <button className='coursebtn'>{course.duration}</button>
                <button className='coursebtn'>{course.seatsLeft}</button>
              </div>
              <p>{course.description}</p>
            </div>
            <div className='p-5 border-b-2'>
              <div className='flex items-center gap-3'>
                <svg stroke="currentColor" fill="none" strokeWidth="1.5" viewBox="0 0 24 24" aria-hidden="true" className="text-[1.1rem]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
              ...
              <ul>
                {course.curriculum.map((item, idx) => (
                  <li key={idx} className='flex items-center gap-3'>
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="check-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                      <path d="m10 15.586-3.293-3.293-1.414 1.414L10 18.414l9.707-9.707-1.414-1.414z"></path>
                    </svg>
                    <p className='text-[#565656]'>{item}</p>
                  </li>
                ))}
              </ul>
            </div>
            <div className='p-5 border-b-2'>
              <div className='flex items-center gap-3'>
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="text-[1.1rem]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
...
const courses = [
  {
    ...
    cardBgClass: "cardbggradient1",
    iconClass: "text-[#945FF6] text-[3rem]",
    duration: "DURATION : 8 MONTHS",
    seatsLeft: "SEATS LEFT : 24",
    description: "Master DSA, Problem Solving, Full Stack and crack top Software Development jobs",
    curriculum: [
  ...
  {
    title: "Java Full-Stack Development Track",
    cardBgClass: "cardbggradient2",
    iconClass: "text-[#007965] text-[3rem]",
    duration: "DURATION : 8 MONTHS",
    seatsLeft: "SEATS LEFT : 24",
    description: "Master DSA, Problem Solving, Full Stack and crack top Software Development jobs",
    curriculum: [
  ...
  {
    title: "Java Full-Stack Development Track",
    cardBgClass: "cardbggradient3",
    iconClass: "text-[#F86241] text-[3rem]",
    duration: "DURATION : 8 MONTHS",
    seatsLeft: "SEATS LEFT : 24",
    description: "Master DSA, Problem Solving, Full Stack and crack top Software Development jobs",
    curriculum: [
